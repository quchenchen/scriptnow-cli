...
| storymap | Novel volumes×chapters: state / generate / **planning-quality (chapter-outline gate)** / **append-volume (add volume, append-only)** / **append-chapters (add chapters, append-only)** / adopt (**HIGH-RISK, requires --confirm**)  / **phases (narrative-structure phase plan)** / **append-phase (submit next phase; phase=volume)** |
